...
$ed=$_POST['edit'];
$ye=$_POST['year'];
if($bn==NULL || $au==NULL || $ed==NULL || $ye==NULL )
{
	$sql=mysqli_query($set,"INSERT INTO books(name,author,editor,year) VALUES('$bn','$au','$ed',$ye')");
	if($sql)
	{
...
<marquee class="clg" direction="right" behavior="alternate" scrollamount="1"><h2>RADHAKRISHNAN</h2></marquee>
</div>
<br />
...
<tr><td class="labels">Editor : </td><td><input type="text" name="edit" placeholder="Enter Editor Name" size="25" class="fields" required="required"  /></td></tr>
<tr><td class="labels">Year of edition : </td><td><input type="text" name="year" placeholder="Enter Year of edition" size="25" class="fields" required="required"  /></td></tr>
